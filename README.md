...
Abstrakta klasser som ärver av ABC måste implementera **getitem** och **len**
...
- Förslag på "arbetsplan" för uppgiften
  ...
  3. Börja med `GenericDocument` och `PartType`
  4. Blanda in `PlainDocument` snarast möjligt
  5. Vänta inte så länge med att blanda in `HTMLDocument` och `MarkdownDocument` också.
  6. Gör lite om vartannat i klasserna och bygg upp dem gradvis. Det är inte
  ...
  7. Gör commit ofta! Försök att att satsa mer på bra commit-meddelanden i
